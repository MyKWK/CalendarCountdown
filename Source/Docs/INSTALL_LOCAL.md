# 知行 1.0.17（macOS Universal）

## 安装 App

1. 打开 `CalendarCountdown-1.0.17-macos-universal.dmg`。
...
```bash
/Volumes/知行\ 1.0.17/calcount version
/Volumes/知行\ 1.0.17/calcount auth
/Volumes/知行\ 1.0.17/calcount import "/Volumes/知行 1.0.17/导入格式示例.json" --dry-run
/Volumes/知行\ 1.0.17/calcount tracking export --output ~/Desktop/important-days.json
```
