# 知行 1.0.13（macOS Universal）

## 安装 App

1. 打开 `CalendarCountdown-1.0.13-macos-universal.dmg`。
...
```bash
/Volumes/知行\ 1.0.13/calcount version
/Volumes/知行\ 1.0.13/calcount auth
/Volumes/知行\ 1.0.13/calcount import "/Volumes/知行 1.0.13/导入格式示例.json" --dry-run
/Volumes/知行\ 1.0.13/calcount tracking export --output ~/Desktop/important-days.json
```
