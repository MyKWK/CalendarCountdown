...
public enum ProductConstants {
    ...
    public static let iOSAppBundleIdentifier = "app.calendarcountdown.CalendarCountdown.ios"
    public static let iOSWidgetBundleIdentifier = "app.calendarcountdown.CalendarCountdown.ios.Widget"
