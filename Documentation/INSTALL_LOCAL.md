# 日历倒数 1.0.3（macOS Universal）

## 安装 App

1. 打开 `CalendarCountdown-1.0.3-macos-universal.dmg`。
...
```bash
/Volumes/日历倒数\ 1.0.3/calcount version
/Volumes/日历倒数\ 1.0.3/calcount auth
/Volumes/日历倒数\ 1.0.3/calcount import "/Volumes/日历倒数 1.0.3/导入格式示例.json" --dry-run
/Volumes/日历倒数\ 1.0.3/calcount tracking export --output ~/Desktop/important-days.json
```
