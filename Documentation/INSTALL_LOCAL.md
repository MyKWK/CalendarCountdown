# 日历倒数 1.0.1（macOS Universal）

## 安装 App

1. 打开 `CalendarCountdown-1.0.1-macos-universal.dmg`。
...
```bash
/Volumes/日历倒数\ 1.0.1/calcount version
/Volumes/日历倒数\ 1.0.1/calcount auth
/Volumes/日历倒数\ 1.0.1/calcount import "/Volumes/日历倒数 1.0.1/导入格式示例.json" --dry-run
/Volumes/日历倒数\ 1.0.1/calcount tracking export --output ~/Desktop/important-days.json
```
