# 知行 1.0.14（macOS Universal）

## 安装 App

1. 打开 `CalendarCountdown-1.0.14-macos-universal.dmg`。
...
```bash
/Volumes/知行\ 1.0.14/calcount version
/Volumes/知行\ 1.0.14/calcount auth
/Volumes/知行\ 1.0.14/calcount import "/Volumes/知行 1.0.14/导入格式示例.json" --dry-run
/Volumes/知行\ 1.0.14/calcount tracking export --output ~/Desktop/important-days.json
```
